...
function ContextBlock() {
  ...
  return (
    <div style={{ background: "#111118", border: "1px solid #2a2a3a", borderRadius: 8, padding: "12px 14px", marginTop: 12 }}>
      ...
      <div style={{ fontSize: 12, lineHeight: 1.6, marginTop: 6 }}><span style={lbl}>THE MOVE · </span>Engineer the buffer so absorbing the shock doesn't slow it down: bound how much history each scan must touch, merge per-shard lists into one priority order, hand work out on short leases so a crash costs a redelivery instead of a loss, and stop feeding unhealthy shards.</div>
