...
export default function DarkDashboards() {
  ...
  const S = {
    ...
    // FIX (2026-07-31 review): INDEPENDENT TELEMETRY is the switch the whole artifact pivots on,
    ...
    <div style={S.root}>
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: 12, marginTop: 12 }}>
        <div style={{ ...S.panel, flex: "1 1 250px", minWidth: 250 }}>
          ...
          <button style={S.tog(indep)} onClick={() => setIndep(!indep)}>INDEPENDENT TELEMETRY: {indep ? "ON" : "OFF"}<div style={{ color: "#6b7080", fontSize: 10 }}>the post-outage remediation - observers off Consul</div></button>
